...
RouteBase get $debugDesignSystemRoute => GoRouteData.$route(
  path: '/debug/design-system',
  hasOverriddenOnExit: false,
  factory: $DebugDesignSystemRoute._fromState,
);

mixin $DebugDesignSystemRoute on GoRouteData {
  static DebugDesignSystemRoute _fromState(GoRouterState state) =>
      const DebugDesignSystemRoute();

  @override
  String get location => GoRouteData.$location('/debug/design-system');
    ...
    StatefulShellBranchData.$branch(
      routes: [
        GoRouteData.$route(
          path: '/my-events',
          hasOverriddenOnExit: false,
          factory: $MyEventsRoute._fromState,
        ),
      ],
    ),
    StatefulShellBranchData.$branch(
...
mixin $EventDetailRoute on GoRouteData {
  static EventDetailRoute _fromState(GoRouterState state) =>
      EventDetailRoute(id: state.pathParameters['id']!);

  EventDetailRoute get _self => this as EventDetailRoute;

  @override
  String get location =>
      GoRouteData.$location('/feed/event/${Uri.encodeComponent(_self.id)}');
...
mixin $MyEventsRoute on GoRouteData {
  static MyEventsRoute _fromState(GoRouterState state) => const MyEventsRoute();

  @override
  String get location => GoRouteData.$location('/my-events');
